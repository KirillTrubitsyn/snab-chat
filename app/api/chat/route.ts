...
---
📋 **Подробная инструкция для пользователей и презентация системы** доступны во вкладке **«Поддержка»**.
Если у вас есть вопросы по работе системы — напишите нам там же.
---
