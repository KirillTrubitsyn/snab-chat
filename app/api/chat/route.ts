...
---
Информацию об использовании системы вы найдёте в разделе [«Поддержка»](#open-support). Если потребуется помощь, мы всегда на связи и готовы ответить на ваши вопросы.
---
