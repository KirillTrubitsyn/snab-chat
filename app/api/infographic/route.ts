...
5. МИНИМИЗИРУЙ количество текста на изображении. Используй иконки, символы, графики и цветовое кодирование вместо длинных надписей. Каждая текстовая надпись — максимум 2-3 слова
