          ...
          <aside className={`sidebar-panel right ${rightOpen ? "open" : ""} ${rightCollapsed ? "collapsed" : ""}`}>
            ...
            {!rightCollapsed && (
              <div className="sidebar-user-profile">
                <a href={isAdmin ? "/admin" : "/settings"} className="sidebar-user-link" title="Настройки аккаунта">
                  <div className="sidebar-user-avatar">{userInitials}</div>
                  <div className="sidebar-user-info">
                    <div className="sidebar-user-name">{userName}</div>
                  </div>
                </a>
                <button className="sidebar-user-logout" onClick={handleLogout} title="Выйти">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
                    <polyline points="16 17 21 12 16 7" />
                    <line x1="21" y1="12" x2="9" y2="12" />
