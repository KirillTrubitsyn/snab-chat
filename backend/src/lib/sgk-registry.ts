...
export const SGK_REGISTRY: SgkEntity[] = [
  ...
  { name: 'АО «Енисейская ТГК (ТГК-13)»', aliases: ["енисейская тгк", "енисейской тгк", "енисейскую тгк", "енисейскою тгк", "енисейск ", "тгк-13", "тгк 13", "тгк13", "етгк", "ао «енисейская тгк»", "ао \"енисейская тгк\""], regime: "223-fz", parentEntity: null, type: "юрлицо", region: "Красноярский край", businessUnit: "Енисейская ТГК" },
